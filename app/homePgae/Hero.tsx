...
const Hero = () => {
  return (
    <section className="border relative h-[650px] sm:h-[700px] md:h-[750px] lg:h-[450px] xl:h-[600px] overflow-hidden bg-white flex flex-col lg:flex-row items-center justify-between lg:pl-10 xl:pl-20 lg:pr-0 lg:py-0 ">
      {/* Background Graphic 1 (Left Top) */}
      <div className="absolute left-[0px] top-[290px] min-[375px]:top-[250px] sm:top-[300px] sm:left-[20px] md:top-[25%] md:left-[40] lg:left-[0%] xl:left-[0%] lg:top-[-5%] xl:top-[-3%] z-0 opacity-80 ">
        <Image
      ...
      {/* Main Image (Left) */}
      <div className="relative order-2 w-[120%] top-[-20px] left-[5%] sm:w-full sm:left-0 sm:top-[-20px] lg:absolute lg:inset-x-0 md:top-0 md:left-[10] lg:top-5 lg:left-[-10] xl:left-[-20] xl:top-[10] lg:right-auto lg:w-6/9 xl:w-6/9 z-10 flex justify-center lg:justify-start pointer-events-none mt-0 lg:mt-0">
        <Image
      ...
      <div className="contents lg:flex lg:flex-col lg:items-end lg:text-right lg:gap-4 xl:gap-6 lg:z-20 lg:mt-0 xl:w-[500px] lg:w-[400px] lg:ml-auto lg:px-0">
        ...
        <div className="order-1 flex flex-col items-center lg:items-end text-center lg:text-right gap-2 z-20 mt-10 lg:mt-0 px-4 lg:px-0">
          <h1 className="text-[#222325] md:text-[25px] text-[22px] sm:text-[24px] lg:text-[36px] xl:text-[45px] font-[900] leading-[38.4px] lg:leading-normal font-extrablack whitespace-normal lg:whitespace-nowrap mb-4 lg:mb-6 xl:mb-8">
          ...
          <p
            className="text-[#222325] text-[12px] sm:text-[13px] md:text-[14px] lg:text-[16px] xl:text-[18px] font-normal leading-[36px] lg:leading-normal font-num-regular max-w-[650px] mt-4 text-justify"
            dir="rtl"
          >
        ...
        {/* Buttons Group */}
        <div className="order-3 flex flex-row gap-4 relative top-[-10px] sm:top-[-90px] md:top-[-30px] lg:top-0 lg:mt-10 z-20">
          {/* Demo Button */}
          <ChamferedButton
      ...
      <div className="absolute left-[60%] top-[71%] min-[375px]:top-[67%] sm:top-[73%] md:top-[65%] md:left-[60%] lg:left-[35%] xl:left-[36%] lg:top-[56%] xl:top-[60%] z-20 opacity-100 pointer-events-none">
        <Image
