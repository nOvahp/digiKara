...
const SolutionItem = ({ title, desc }: SolutionItemProps) => {
  return (
    <div className="w-full flex justify-start items-start gap-4">
      {/* Icon/Bullet (Placed first for RTL) */}
      ...
      <div className="flex-1 text-right">
        <span className="text-[#222325] text-[14px] lg:text-[16px] font-['num-semibold'] font-semibold leading-[24px] tracking-wide wrap-break-word">
          {title}{" "}
        </span>
