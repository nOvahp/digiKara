...
const PartnersTitle = () => {
  return (
    <div className="w-full flex flex-col justify-start items-center lg:items-start lg:sticky">
      <div className="self-stretch text-center lg:text-right text-[#585858] text-[20px] lg:text-[24px] font-black">
        سازمان‌ها و شرکت‌ها
      </div>
      <div className="self-stretch text-center lg:text-right text-[#222325] text-[30px] lg:text-[45px] font-black leading-[50px] lg:leading-[72px] mb-[3%]">
