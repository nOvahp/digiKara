...
export function ConfirmModal({ isOpen, onClose, onConfirm, title, message, isLoading = false }: ConfirmModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            {/* Modal Card */}
            <div className="relative w-full max-w-[400px] bg-white rounded-2xl shadow-xl flex flex-col items-center p-6 gap-4" dir="rtl">
                ...
                <div className="flex flex-col items-center gap-2 text-center">
                    <div className="text-[#0D0D12] text-lg font-bold font-['PeydaWeb']">
                        {title}
                    </div>
