...
// Customer phone input — NO back button, customer cannot navigate to other pages.
// status=3 means existing customer with password → skip OTP, go directly to login.
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-white items-center relative overflow-hidden" dir="rtl">
      ...
      <div className="w-full h-full flex flex-col items-center p-6 z-10">
        ...
        <div className="w-full max-w-md flex justify-start items-center py-6">
        ...
        <div className="flex flex-col flex-1 w-full max-w-md mt-10">
          <div className="mb-10 text-right space-y-4">
            <h1 className="text-[#393E46] text-4xl font-black leading-tight">ورود به بازارچه</h1>
