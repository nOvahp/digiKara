            ...
            interests.map((interest, index) => {
              ...
              return (
                <React.Fragment key={interest.id}>
                  ...
                  >
                    ...
                    <div className="flex items-start gap-4 flex-1 justify-end">
                      <div className="flex flex-col items-end gap-1 text-right">
                        <span className="text-[#0C1415] text-base font-bold">{interest.title}</span>
                      ...
                      {/* Icon Box */}
                      <div
                        className={`w-[43px] h-[43px] rounded-2xl flex items-center justify-center shrink-0 ${style.bg}`}
                      >
                  ...
                  {/* Divider */}
                  {index < interests.length - 1 && <div className="h-[1px] w-full bg-gray-100" />}
                </React.Fragment>
              );
            })
          )}
