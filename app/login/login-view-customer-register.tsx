...
export function LoginViewCustomerRegister({
  onNext,
  phone,
  onBack,
}: LoginViewCustomerRegisterProps) {
  ...
  return (
    <div
      className="flex min-h-screen w-full flex-col bg-white items-center relative overflow-y-auto"
      dir="rtl"
    >
      {/* Header Background */}
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="w-full flex flex-col gap-5 pb-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              <Label htmlFor="firstname" className="text-xs font-bold mr-1">
                نام
              </Label>
              <Input
                {...form.register('firstname')}
                placeholder=""
                className="rounded-xl border-[#DCE4E8] bg-[#F3F6FC]"
              />
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor="lastname" className="text-xs font-bold mr-1">
                نام خانوادگی
              </Label>
              <Input
            ...
            <div className="flex gap-4">
              <label className="flex items-center gap-2 cursor-pointer bg-[#F3F6FC] px-4 py-3 rounded-xl flex-1 border border-transparent has-[:checked]:border-[#FDD00A] transition-all">
                <input
                  ...
                  className="w-4 h-4 accent-[#FDD00A]"
                />
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="password" className="text-xs font-bold mr-1">
              رمز عبور
            </Label>
            <Input
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="password_confirmation" className="text-xs font-bold mr-1">
              تکرار رمز عبور
            </Label>
            <Input
              ...
              onChange={(e) => {
                const val = toEnglishDigits(e.target.value);
                form.setValue('password_confirmation', val, {
                  shouldValidate: true,
                });
              }}
            />
          ...
          <div className="flex flex-col gap-2 opacity-60">
            ...
            <Input
              ...
              readOnly
              disabled
              className="rounded-xl border-dashed border-gray-300 bg-gray-50 text-center font-mono"
              dir="ltr"
            />
          </div>
