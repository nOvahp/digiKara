...
export function LoginHeaderText({ stage, phoneNumber }: LoginHeaderTextProps) {
  return (
    <div className="absolute top-14 right-3 z-20 flex flex-col justify-center items-end gap-4">
        <div className="text-right text-[#393E46] text-[36px] font-['MeemFaNum'] font-extrabold leading-[43.20px] break-words">
          {stage === "PHONE_ENTRY" ? "وارد حساب خود شوید" : "کد تایید"}
        </div>
        <div className="text-right text-[#393E46] text-[14px] font-['MeemFaNum'] font-medium leading-[19.60px] break-words">
          {stage === "PHONE_ENTRY" 
