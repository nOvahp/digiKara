      ...
      <div className="relative w-full max-w-[440px] pointer-events-auto">
        <div className="w-full bg-white shadow-[0px_0px_4px_#E9B443] rounded-t-[20px] flex flex-col justify-center items-center gap-1 pb-2 pt-2">
          <div className="w-full flex justify-between items-center px-4">
            {/* School Profile */}
            <Link
              href="/SchoolPanel/SchoolProfile"
              className={getItemClasses(isActive('/SchoolPanel/SchoolProfile'))}
            >
              <School
                className={cn('w-6 h-6', getIconColor(isActive('/SchoolPanel/SchoolProfile')))}
                strokeWidth={1.5}
              />
              <div className={getTextClasses(isActive('/SchoolPanel/SchoolProfile'))}>
                پروفایل مدرسه{' '}
              </div>
            </Link>
            ...
            {/* Report */}
            <Link
              href="/SchoolPanel/Reports"
              className={getItemClasses(isActive('/SchoolPanel/Reports'))}
            >
              <FileText
            ...
            <Link href="/SchoolPanel" className={getItemClasses(isActive('/SchoolPanel'))}>
              <Home
                className={cn('w-6 h-6', getIconColor(isActive('/SchoolPanel')))}
                strokeWidth={1.5}
              />
            ...
            {/* Projects */}
            <Link
              href="/SchoolPanel/Projects"
              className={getItemClasses(
                pathname.startsWith('/SchoolPanel/Projects') ||
            ...
            >
              <BookOpen
                className={cn('w-6 h-6', getIconColor(isActive('/SchoolPanel/Education')))}
                strokeWidth={1.5}
              />
