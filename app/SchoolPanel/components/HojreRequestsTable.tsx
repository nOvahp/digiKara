...
const HojreRequestsTable = () => {
    ...
    const filteredRequests = requests.filter(req => {
        ...
        const matchesStatus = 
            ...
            filterStatus === 'approved' ? req.approved :
            filterStatus === 'pending' ? !req.approved : true;
    ...
    return (
        ...
        <div className="w-full flex flex-col gap-1 mb-0" dir="rtl">
             ...
             <div className={`w-full ${!isListEmpty ? 'bg-white shadow-[0px_2px_4px_-1px_rgba(13,13,18,0.06)] rounded-xl outline outline-1 outline-[#DFE1E7] overflow-hidden' : ''} flex flex-col justify-start items-end`}>
                 ...
                 {/* Search & Filter */}
                 <div className={`w-full px-5 py-4 ${!isListEmpty ? 'border-b border-[#DFE1E7] bg-white' : ''} flex flex-col gap-4`}>
                        ...
                        return (
                         ...
                         >
                            ...
                            <div className="w-14 h-16 px-3 flex justify-center items-center">
                                <span className="text-center text-[#0D0D12] text-sm font-num-medium font-medium">{toFarsiNumber(itemIndex)}</span>
                            </div>
