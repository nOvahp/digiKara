...
const InfoField = ({
  ...
  <div className={`w-full ${className}`}>
    ...
    <div className="w-full min-h-[3.5rem] h-auto py-2 border border-[#DCE4E8] rounded-3xl flex items-center justify-start gap-3 px-4 bg-white relative">
      ...
      <span
        className="text-[#393E46] text-sm font-bold flex-1 text-right break-words leading-relaxed"
        dir="auto"
      >
        {value || '---'}
      </span>
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 w-full px-6 pt-4 pb-2 shrink-0">
          ...
          {loading ? (
            <div className="h-20 flex items-center justify-center text-gray-500 font-bold">
              در حال بارگذاری...
            </div>
          ) : data ? (
          ...
          {data && (
            <div className="space-y-6 pt-2 pb-20">
              ...
              <div className="w-full">
                <div className="flex justify-start items-center mb-[-12px] pr-4 relative z-10">
                  <span className="bg-white px-2 text-[#ACB5BB] text-xs font-bold font-peyda">
                    توضیحات
                  </span>
                </div>
              ...
              <div className="w-full">
                ...
                <div
                  className={`w-full h-14 border border-[#DCE4E8] rounded-full flex items-center justify-between px-5 bg-white relative ${data.approved ? 'bg-[#ECF9F7]/30' : 'bg-[#FFF4E5]/30'}`}
                >
                  {data.approved ? (
                  ...
                  <span
                    className={`text-sm font-bold truncate flex-1 text-right ${data.approved ? 'text-[#267666]' : 'text-[#B98900]'}`}
                  >
