  ...
  return (
    <div className="w-full min-h-screen pb-4 flex flex-col items-center pt-4 gap-6" dir="rtl">
      ...
      <div className="w-full flex justify-between items-center">
        <h1 className="text-[#0D0D12] text-xl font-['PeydaWeb'] font-semibold">کیف پول مدرسه</h1>
      </div>
          ...
          <div className="flex-1 flex justify-end items-center gap-2">
            ...
            <div className="flex-1 flex flex-col justify-start items-center gap-1">
              ...
              <div className="w-full text-center flex flex-col justify-center">
                <span className="text-white text-xs font-num-medium font-semibold leading-[18.6px]">
                  {toFarsiNumber('432,760,000')}
                </span>
                <span className="text-white text-[10px] font-num-medium font-light leading-[15.5px]">
                  ریال
                </span>
              </div>
            </div>
      ...
      <div className="w-full flex flex-col gap-4">
        ...
        <div className="w-full flex gap-2 overflow-x-auto no-scrollbar pb-1">
          ...
          >
            <span
              className={cn('text-[#0D0D12] text-sm', activeFilter === 'all' && 'font-semibold')}
            >
              همه
            </span>
          ...
          >
            <span
              className={cn('text-[#0D0D12] text-sm', activeFilter === 'school' && 'font-semibold')}
            >
              مدرسه
            </span>
          ...
          >
            <span
              className={cn(
                'text-[#0D0D12] text-sm',
                activeFilter === 'student' && 'font-semibold',
              )}
            >
              دانش آموزان
            </span>
          ...
          >
            <span
              className={cn(
                'text-[#0D0D12] text-sm',
                activeFilter === 'teacher' && 'font-semibold',
              )}
            >
              معلم
            </span>
            ...
            <button
              ...
              className={cn(
                ...
                currentPage === totalPages || totalPages === 0
                  ? 'opacity-50 cursor-not-allowed bg-gray-50 bg-opacity-50'
