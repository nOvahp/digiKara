        ...
        <div className="w-full min-h-screen pb-4 flex flex-col items-center pt-4 gap-6" dir="rtl">
            ...
            <div className="w-full flex flex-col gap-4">
                ...
                <div className="w-full flex gap-2 overflow-x-auto no-scrollbar pb-1">
                     {/* All */}
                     <div className="flex items-center gap-2 px-4 py-1.5 rounded-xl border border-[#818898] bg-white whitespace-nowrap cursor-pointer">
                         <span className="text-[#0D0D12] text-sm">همه</span>
                         <LayoutGrid className="w-4 h-4 text-[#0D0D12]" />
                     </div>
                     {/* School */}
                     <div className="flex items-center gap-2 px-4 py-1.5 rounded-xl border border-[#818898] bg-[#FDD00A] whitespace-nowrap cursor-pointer">
                         <span className="text-[#0D0D12] text-sm font-semibold">مدرسه</span>
                         <School className="w-4 h-4 text-[#0D0D12]" />
                     </div>
                      {/* Students */}
                      <div className="flex items-center gap-2 px-4 py-1.5 rounded-xl border border-[#818898] bg-white whitespace-nowrap cursor-pointer">
                         <span className="text-[#0D0D12] text-sm">هنرجویان</span>
                         <Users className="w-4 h-4 text-[#0D0D12]" />
                     </div>
                     {/* Teachers */}
                     <div className="flex items-center gap-2 px-4 py-1.5 rounded-xl border border-[#818898] bg-white whitespace-nowrap cursor-pointer">
                         <span className="text-[#0D0D12] text-sm">هنرآموز</span>
                ...
                <div className="w-full px-5 py-2 flex justify-between items-center mt-2">
                            <div className="flex items-center gap-2">
                                <button 
                                    ...
                                    className={cn(
                                        ...
                                        currentPage === totalPages ? "opacity-50 cursor-not-allowed bg-gray-50 bg-opacity-50" : "hover:bg-gray-50 cursor-pointer"
                                    )}
                                >
                            ...
                            <span className="text-[#0D0D12] text-sm font-num-medium">صفحه {toFarsiNumber(currentPage)} از {toFarsiNumber(totalPages)}</span>
                </div>
            </div>
        </div>
    );
