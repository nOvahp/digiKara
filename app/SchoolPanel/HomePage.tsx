...
const SchoolHomePage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-white pb-12 pt-5 px-0 flex flex-col gap-6" dir="rtl">
          ...
          <div className="flex-1 p-4 bg-white shadow-[0px_2px_4px_-1px_rgba(13,13,18,0.06)] rounded-xl outline outline-1 outline-[#DFE1E7] -outline-offset-1 flex flex-col justify-start items-start gap-2.5 relative">
            <div className="self-stretch flex flex-col justify-start items-start gap-0.5">
              <div className="self-stretch flex justify-start items-center gap-2.5">
                ...
                <span className="flex-1 text-center text-[#818898] text-sm font-['PeydaWeb'] font-semibold leading-[21px] tracking-wide break-word">
                  کل فروش
                </span>
              </div>
              <div className="self-stretch flex justify-start items-center gap-2 mt-2">
                <span className="w-full text-center text-[#0D0D12] text-2xl font-num-medium font-semibold leading-[31.2px] break-word">
            ...
            <div className="self-stretch flex justify-start items-center gap-1">
              ...
              <span className="text-[#818898] text-xs font-['PeydaWeb'] font-light opacity-0">
                .
              </span>
            </div>
          ...
          <div className="flex-1 p-4 bg-white shadow-[0px_2px_4px_-1px_rgba(13,13,18,0.06)] rounded-xl outline outline-1 outline-[#DFE1E7] -outline-offset-1 flex flex-col justify-start items-start gap-2.5 relative">
            <div className="self-stretch flex flex-col justify-start items-start gap-0.5">
              <div className="self-stretch flex justify-start items-center gap-2.5">
                ...
                <div className="flex-1 text-center text-[#818898] text-sm font-['PeydaWeb'] font-semibold leading-[21px] tracking-wide break-word">
                  سفارشات
                </div>
              </div>
              <div className="self-stretch flex justify-start items-center gap-2 mt-2">
                <div className="w-full text-center text-[#0D0D12] text-2xl font-num-medium font-semibold leading-[31.2px] break-word">
                  {toFarsiNumber(stats.completedOrders)}{' '}
                  <span className="text-sm text-[#818898]">
                    / {toFarsiNumber(stats.ordersCount)}
                  </span>
                </div>
              </div>
            </div>
            <div className="self-stretch flex justify-start items-center gap-1">
              <div className="flex-1 text-center text-[#818898] text-xs font-['PeydaWeb'] font-light leading-[18px] tracking-wide break-word">
                تکمیل شده
              </div>
            </div>
        ...
        <div className="flex gap-3 w-full">
          ...
          <div className="flex-1 p-4 bg-white shadow-[0px_2px_4px_-1px_rgba(13,13,18,0.06)] rounded-xl outline outline-1 outline-[#DFE1E7] -outline-offset-1 flex flex-col justify-start items-start gap-2.5 relative">
            <div className="self-stretch flex flex-col justify-start items-start gap-0.5">
              ...
              <div className="self-stretch flex justify-start items-center gap-2 mt-2">
                <div className="w-full text-center text-[#0D0D12] text-2xl font-num-medium font-semibold leading-[31.2px] break-word">
                  {toFarsiNumber(stats.activeBooths)}{' '}
                  <span className="text-sm text-[#818898]">
                    / {toFarsiNumber(stats.totalBooths)}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-0.5">
              ...
              <div className="w-full text-center rtl:flex rtl:justify-center rtl:items-baseline rtl:gap-1 mt-2">
                <span className="text-[#0D0D12] text-2xl font-num-medium font-semibold leading-[31.2px]">
                  {toFarsiNumber(stats.activeStudents)}{' '}
                  <span className="text-sm text-[#818898]">
                    / {toFarsiNumber(stats.totalStudents)}
                  </span>
                </span>
              </div>
            </div>
      ...
      <div className="flex flex-col gap-4 w-full mt-2">
        <div className="flex justify-between items-center w-full">
          ...
          <div className="flex items-center gap-1 cursor-pointer">
            <span className="text-[#6C7278] text-xs font-['PeydaWeb'] font-semibold">
              مشاهده همه
            </span>
      ...
      <div className="flex flex-col gap-4 w-full mt-2">
        ...
        <div className="w-full p-3.5 rounded-xl border border-[#DCE4E8] flex flex-col justify-start items-center gap-3">
          ...
          <div className="w-full h-12 px-6 py-[13px] bg-[#F7C61A] rounded-xl flex justify-center items-center gap-2.5 cursor-pointer hover:bg-[#e5b818]">
            <div className="text-center text-[#393E46] text-base font-['peyda-Num'] font-extrabold leading-snug break-word">
              برو به صفحه همکاری
            </div>
      ...
      {/* Smart Suggestions */}
      <div className="flex flex-col gap-4 w-full mt-2">
        <h2 className="text-[#0D0D12] text-xl font-['PeydaWeb'] font-semibold text-start">
          پیشنهادات هوشمند
        </h2>
        <div className="flex gap-2 overflow-x-auto pb-4 no-scrollbar -mx-4 px-4">
          {[
            {
              title: 'دوره آموزشی مدیریت مالی',
              desc: 'با مشاهده این دوره کوتاه ۵ دقیقه‌ای، یاد بگیرید چگونه گزارش‌های مالی فصلی مدرسه را بهینه‌تر تحلیل کنید..',
            },
            {
              title: 'این سرویس در منطقه شما محبوب است.',
              desc: '«مدارس منطقه شما « تغذیه ارگانیک» را اضافه کرده‌اند. این خدمت با استقبال خوب  روبرو شده است.',
            },
          ].map((item, idx) => (
            <Card
              key={idx}
              className="min-w-[250px] p-3 bg-white rounded-lg shadow-sm border border-gray-100 flex flex-col gap-2"
            >
              <Lightbulb className="w-6 h-6 text-[#FDD00A]" />
              <span className="text-[#0F172A] text-sm font-medium text-right font-['PeydaWeb']">
                {item.title}
              </span>
              <p className="text-[#888B90] text-[10px] font-medium text-right leading-4 font-['PeydaWeb']">
                {item.desc}
              </p>
            </Card>
          ))}
