        ...
        <div className="flex flex-col gap-6">
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select onValueChange={field.onChange} defaultValue={field.value} dir="rtl">
                  <SelectTrigger
                    className={cn(
                      'w-full h-[52px] bg-white rounded-xl border border-[#DFE1E7] shadow-none focus:ring-0 focus:border-[#FDD00A] text-right',
                      errors.timche && 'border-red-500',
                    )}
                  >
          ...
          {needsSupport && (
            <div className="flex flex-col gap-2">
              ...
              />
              {errors.supportType && (
                <span className="text-xs text-red-500">{errors.supportType.message}</span>
              )}
            </div>
          )}
        </div>
