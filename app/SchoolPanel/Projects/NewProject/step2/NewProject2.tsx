      ...
      <div className="w-full max-w-md mx-auto p-0 flex flex-col gap-6">
        ...
        <div className="w-full py-5 flex items-center gap-4 overflow-x-auto border-b border-[#DFE1E7] no-scrollbar">
          ...
          <div className="flex items-center gap-2.5 flex-shrink-0 opacity-50">
            <div className="w-6 h-6 bg-[#DFE1E7] rounded-full flex items-center justify-center">
              <span className="text-white text-sm font-bold font-num-medium">
                {toFarsiNumber(1)}
              </span>
            </div>
        ...
        <div className="flex flex-col gap-6 px-0">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select onValueChange={field.onChange} defaultValue={field.value} dir="rtl">
                  <SelectTrigger
                    className={cn(
                      'w-full h-[52px] bg-white rounded-xl border border-[#DFE1E7] shadow-none focus:ring-0 focus:border-[#FDD00A]',
                  ...
                  >
                    <div className="flex items-center justify-between w-full">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#818898] text-base font-semibold font-['PeydaWeb']">
                          نفر
                        </span>
                      </div>
            ...
            />
            {errors.staffCount && (
              <span className="text-xs text-red-500">{errors.staffCount.message}</span>
            )}
          </div>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-end">
              <label className="text-[#666D80] text-sm font-semibold font-['PeydaWeb']">
                تجهیزات مورد نیاز
              </label>
              ...
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  className="flex items-center gap-1 px-2 py-0.5 bg-gradient-to-r from-[#8B5CF6] to-[#3B82F6] rounded-full hover:opacity-90 transition-opacity group shadow-[0px_2px_4px_rgba(59,130,246,0.2)]"
                >
                  <Sparkles className="w-3 h-3 text-white" />
                  <span className="text-white text-[9px] font-bold font-['PeydaWeb']">
                    تولید با هوش مصنوعی
                  </span>
                </button>
                <span className="text-[#666D80] text-[10px] font-semibold font-['PeydaWeb']">
                  هر مورد در یک خط
                </span>
              </div>
            </div>
            <div
              className={cn(
                'w-full h-[200px] bg-white rounded-xl border flex flex-col p-3',
                errors.equipment ? 'border-red-500' : 'border-[#DFE1E7]',
              )}
            >
              <textarea
                {...register('equipment')}
              ...
              <div className="w-full flex justify-end">
                <span className="text-[#A4ACB9] text-xs font-light font-num-medium">
                  {toFarsiNumber(equipmentValue?.length || 0)}/{toFarsiNumber(200)}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div
              className={cn(
                'w-full h-[200px] bg-white rounded-xl border flex flex-col p-3',
                errors.consumables ? 'border-red-500' : 'border-[#DFE1E7]',
              )}
            >
              <textarea
              ...
              <div className="w-full flex justify-end">
                <span className="text-[#A4ACB9] text-xs font-light font-num-medium">
                  {toFarsiNumber(consumablesValue?.length || 0)}/{toFarsiNumber(200)}
                </span>
              </div>
            </div>
          </div>
