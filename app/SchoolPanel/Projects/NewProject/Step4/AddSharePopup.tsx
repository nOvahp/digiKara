...
const MOCK_USERS = [
    { id: 101, name: "علی محمدی", wallet: "ZA-AB-9443-1245", type: "student", avatar: "/Avatar.png" },
    { id: 102, name: "رضا کریمی", wallet: "ZA-CD-1122-3344", type: "student", avatar: "/Avatar.png" },
    { id: 103, name: "حجره لوازم التحریر", wallet: "ST-AB-9988-7766", type: "booth", avatar: "/Avatar.png" },
];
...
const AddSharePopup = ({ isOpen, onClose, onAdd }: AddSharePopupProps) => {
    ...
    const handleSearch = (query: string) => {
        ...
        if (query.length > 1) {
            const filtered = MOCK_USERS.filter(u =>
                u.name.includes(query) && u.type === userType
            );
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/50 backdrop-blur-sm">
            <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-[380px] bg-white rounded-2xl flex flex-col overflow-hidden max-h-[90vh]">
                ...
                <div className="p-5 flex flex-col gap-4 overflow-y-auto" dir="rtl">
                    ...
                    <div className="flex flex-col gap-2 relative">
                        ...
                        <div className={cn("w-full h-[52px] px-3 bg-white rounded-xl border flex items-center gap-2", errors.selectedUser ? "border-red-500" : "border-[#DFE1E7]")}>
                        ...
                        {errors.selectedUser && <span className="text-xs text-red-500">{errors.selectedUser.message}</span>}
