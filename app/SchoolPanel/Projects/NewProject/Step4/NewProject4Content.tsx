...
import { ChevronLeft, Trash2, Plus, Minus, PlusCircle as PlusCircleIcon } from "lucide-react"; // Renaming PlusCircle to avoid conflict if needed, though Plus is distinct.
import { cn } from "@/lib/utils";
import Image from "next/image";

// Mock Data for Initial State
const initialStaff = [
    { id: 1, name: "فرید سلیمی", code: "0012345678", share: 40, avatar: "https://placehold.co/46x46" },
    { id: 2, name: "سهند حسینی", code: "0012345678", share: 15, avatar: "https://placehold.co/46x46" },
    { id: 3, name: "سعید محمدی", code: "0012345678", share: 15, avatar: "https://placehold.co/46x46" },
];
...
const NewProject4Content = () => {
    ...
    const [staffShares, setStaffShares] = useState(initialStaff);
    ...
    const handleAddShare = (data: any) => {
        // Add new item to staffShares (Mock)
        const newId = Math.max(...staffShares.map(s => s.id), 0) + 1;
        setStaffShares(prev => [
            ...prev,
            { 
                id: newId, 
                name: "کاربر جدید", // Placeholder as input isn't fully wired
                code: "0000000000", 
                share: data.share, 
