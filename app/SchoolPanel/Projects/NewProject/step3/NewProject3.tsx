...
const step3Schema = z.object({
    estimatedCost: z.string().min(1, "هزینه تخمینی الزامی است").regex(/^\d+$/, "فقط عدد وارد کنید"),
    estimatedRevenue: z.string().min(1, "درآمد تخمینی الزامی است").regex(/^\d+$/, "فقط عدد وارد کنید"),
    estimatedProfit: z.string().min(1, "سود تخمینی الزامی است").regex(/^\d+$/, "فقط عدد وارد کنید"),
});
...
const NewProject3 = () => {
    ...
    const {
        ...
        defaultValues: {
            ...
            estimatedRevenue: projectData.estimatedRevenue || "",
            estimatedProfit: projectData.estimatedProfit || "",
        },
    });
    ...
    const onSubmit = (data: Step3FormValues) => {
        ...
        router.push('/SchoolPanel/Projects/NewProject/Step4');
    };
            ...
            <div className="w-full max-w-md mx-auto p-0 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6 px-0">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className={cn("relative w-full h-[52px] bg-white rounded-xl border flex items-center px-3", errors.estimatedCost ? "border-red-500" : "border-[#DFE1E7]")}>
                        ...
                        {errors.estimatedCost && <span className="text-xs text-red-500">{errors.estimatedCost.message}</span>}
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className={cn("relative w-full h-[52px] bg-white rounded-xl border flex items-center px-3", errors.estimatedRevenue ? "border-red-500" : "border-[#DFE1E7]")}>
                            <span className="text-[#818898] text-base font-semibold font-['PeydaWeb'] ml-2">ریال</span>
                            <input
                        ...
                        {errors.estimatedRevenue && <span className="text-xs text-red-500">{errors.estimatedRevenue.message}</span>}
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className={cn("relative w-full h-[52px] bg-white rounded-xl border flex items-center px-3", errors.estimatedProfit ? "border-red-500" : "border-[#DFE1E7]")}>
                            <span className="text-[#818898] text-base font-semibold font-['PeydaWeb'] ml-2">ریال</span>
                            <input
                        ...
                        {errors.estimatedProfit && <span className="text-xs text-red-500">{errors.estimatedProfit.message}</span>}
                    </div>
