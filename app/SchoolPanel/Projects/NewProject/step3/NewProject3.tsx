      ...
      <div className="w-full max-w-md mx-auto p-0 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-6 px-0">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div
              className={cn(
                'relative w-full h-[52px] bg-white rounded-xl border flex items-center px-3',
            ...
            {errors.estimatedCost && (
              <span className="text-xs text-red-500">{errors.estimatedCost.message}</span>
            )}
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            {errors.estimatedRevenue && (
              <span className="text-xs text-red-500">{errors.estimatedRevenue.message}</span>
            )}
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            {errors.estimatedProfit && (
              <span className="text-xs text-red-500">{errors.estimatedProfit.message}</span>
            )}
          </div>
        </div>
