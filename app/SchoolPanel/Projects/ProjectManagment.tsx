    ...
    >
      ...
      <div className="w-full flex flex-col justify-center items-end gap-3">
        ...
        <div className="self-stretch flex justify-end items-start gap-1">
          <div className="flex-1 h-9 bg-white rounded-lg border border-[#DFE1E7] flex justify-start items-center">
            ...
            <div className="flex-1 h-9 px-2 py-1 flex justify-start items-center gap-2.5">
              <div className="opacity-50 text-[#737373] text-sm font-semibold leading-5">
                جستوجو در تیمچه ها
              </div>
            </div>
          ...
          <div className="w-9 self-stretch px-0 py- bg-white rounded-lg border border-[#DFE1E7] flex justify-center items-center gap-2">
        ...
        <div className="self-stretch flex justify-between items-center">
          {filterTabs.map((tab) => (
            ...
            >
              <div
                className={`text-sm font-['PeydaWeb'] font-semibold leading-5 ${
      ...
      <div className="w-full flex flex-col items-end gap-3">
        <div className="w-full flex justify-between items-center">
          <div className="text-center text-[#0D0D12] text-base font-['PeydaWeb'] font-semibold leading-[21.6px]">
            بررسی و تائید درخواست های اخیر
          </div>
          <div className="text-right text-[#6C7278] text-xs font-['PeydaWeb'] font-semibold">
            همه درخواست ها
          </div>
        </div>
        ...
        <div className="w-full p-3.5 rounded-xl outline outline-1 outline-[#DCE4E8] -outline-offset-1 flex flex-col gap-3 bg-white">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <div className="w-full flex justify-between items-center">
                  <div className="w-[100px] flex items-center gap-1.5">
                    ...
                    <span className="text-[#666D80] text-xs font-['PeydaFaNum'] font-semibold leading-[20.4px] tracking-wide">
                      اکبر رضایی
                    </span>
                  </div>
                  <div className="w-[100px] flex items-center gap-1.5">
          ...
          <div className="w-full flex items-center gap-2.5">
            <div className="flex-1 h-[35px] bg-[#FDD00A] rounded-xl flex items-center justify-center cursor-pointer hover:bg-[#e5c109]">
              <span className="text-[#393E46] text-base font-['PeydaWeb'] font-semibold">
                مشاهده جزئیات کامل
              </span>
            </div>
      ...
      <div className="w-full flex flex-col justify-start items-start gap-4">
        ...
        {/* Table Container */}
        <div className="w-full bg-white shadow-[0px_2px_4px_-1px_rgba(13,13,18,0.06)] rounded-xl outline outline-1 outline-[#DFE1E7] flex flex-col justify-start items-end">
          {/* Header */}
            ...
            <div className="flex justify-start items-center gap-2">
              <div className="flex items-center gap-2" ref={filterRef}>
                <div className="relative">
                  <div
                    className={`w-8 h-8 rounded-lg outline outline-1 outline-[#DFE1E7] flex justify-center items-center gap-2 cursor-pointer transition-colors ${isFilterOpen ? 'bg-gray-100 ring-2 ring-blue-100' : 'bg-white hover:bg-gray-50'}`}
              ...
              <div className="w-8 h-8 p-2 bg-white rounded-lg outline outline-1 outline-[#DFE1E7] flex justify-center items-center gap-2 cursor-pointer hover:bg-gray-50">
