                ...
                <div className="self-stretch flex justify-between items-center">
                    {filterTabs.map((tab) => (
                        <div
                            ...
                            className={`h-8 px-4 rounded-xl border border-[#E5E5E5] shadow-[0px_1px_2px_rgba(0,0,0,0.10)] flex justify-center items-center gap-1.5 cursor-pointer ${activeFilter === tab.id ? "bg-[#F7C61A]" : "bg-white"
                                }`}
                        >
                            <div className={`text-sm font-['PeydaWeb'] font-semibold leading-5 ${activeFilter === tab.id ? "text-[#393E46]" : "text-[#737373]"
                                }`}>
                                {tab.label}
                            </div>
                        </div>
