      ...
      >
        ...
        <div className="self-stretch px-6 py-4 border-b border-[#DFE1E7] flex justify-between items-center bg-white">
          <div className="flex items-center gap-2">
            ...
            <div className="text-[#0D0D12] text-16 font-['PeydaWeb'] font-light leading-24 tracking-wide break-word">
              اعلان ها
            </div>
          </div>
          <div className="text-[#3D424A] text-sm font-['PeydaWeb'] font-light underline leading-[21px] tracking-wide break-word cursor-pointer">
              ...
              <div className="flex-1 flex flex-col justify-start items-start gap-1">
                <div className="self-stretch flex flex-col justify-start items-end gap-2">
                  <div className="self-stretch flex justify-between items-center">
                    <div className="text-right text-[#0D0D12] text-sm font-['PeydaWeb'] font-light leading-[21px] tracking-wide break-word">
                  ...
                  <div className="self-stretch text-right text-[#666D80] text-xs font-['PeydaWeb'] font-light leading-[18px] tracking-wide break-word">
                    شما یک سفارش جدید INV-{toFarsiNumber('1404')}-{toFarsiNumber('567')} از مینا
                    حسینی به ارزش {toFarsiNumber('12,450,000')} ریال دریافت کرده اید.
                  </div>
                </div>
                <div className="self-stretch flex justify-between items-center mt-1">
                  <div className="h-5 px-2 bg-[#DCF6FC] rounded-[36px] flex justify-center items-center gap-2">
                    <div className="text-center text-[#222831] text-xs font-['PeydaWeb'] font-semibold leading-[18px] tracking-wide min-w-[70px]">
                      پیام مدیر مدرسه{' '}
                    </div>
                  </div>
                  <div className="text-[#666D80] text-xs font-['PeydaWeb'] font-light leading-[18px] tracking-wide break-word">
                    {toFarsiNumber(5)} دقیقه پیش
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="self-stretch py-4 flex justify-start items-start gap-3 border-b border-dashed border-[#E5E7EB]">
              ...
              <div className="flex-1 flex flex-col justify-start items-start gap-1">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                  <div className="self-stretch flex justify-between items-center">
                    <div className="text-[#0D0D12] text-sm font-['PeydaWeb'] font-light leading-[21px] tracking-wide break-word">
                      گزارش فروش ماهانه ایجاد شد
                    </div>
                    <div className="w-2 h-2 bg-[#DF1C41] rounded-full" />
                  </div>
                  <div className="self-stretch text-right text-[#666D80] text-xs font-['PeydaWeb'] font-light leading-[18px] tracking-wide break-word">
                    گزارش عملکرد فروش شما برای آبان {toFarsiNumber(1404)} اکنون برای دانلود در دسترس
                    است.
                  </div>
                </div>
                <div className="self-stretch flex justify-between items-center mt-1">
                  <div className="h-5 px-2 bg-[#FFF0CC] rounded-[36px] flex justify-center items-center gap-2">
                    <div className="text-center text-[#222831] text-xs font-['PeydaWeb'] font-semibold leading-[18px] tracking-wide min-w-[60px]">
                      پیام سامانه
                    </div>
                  </div>
                  <div className="text-[#666D80] text-xs font-['PeydaWeb'] font-light leading-[18px] tracking-wide break-word">
                    {toFarsiNumber(20)} دقیقه پیش
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="self-stretch py-4 flex justify-start items-start gap-3 border-b border-dashed border-[#E5E7EB]">
              ...
              <div className="flex-1 flex flex-col justify-start items-end gap-1">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                  ...
                  <div className="self-stretch text-right text-[#666D80] text-xs font-['PeydaWeb'] font-light leading-[18px] tracking-wide break-word">
                    پرداخت برای سفارش INV-{toFarsiNumber(1404)}-{toFarsiNumber(234)} ناموفق بود.
                    لطفا روش پرداخت را بررسی کنید.
                  </div>
                </div>
                <div className="self-stretch flex justify-between items-center mt-1">
              ...
              <div className="flex-1 flex flex-col justify-start items-start gap-1">
                ...
                <div className="self-stretch flex justify-between items-center mt-1">
                  <div className="h-5 px-2 bg-[#FEDBCC] rounded-[36px] flex justify-center items-center gap-2">
                    <div className="text-center text-[#222831] text-xs font-['PeydaWeb'] font-semibold leading-[18px] tracking-wide min-w-[80px]">
                      پیام از پشتیبانی
                    </div>
                  </div>
                  <div className="text-[#666D80] text-xs font-['PeydaWeb'] font-light leading-[18px] tracking-wide break-word">
                    {toFarsiNumber(1)} ساعت پیش
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="self-stretch px-6 py-4 border-t border-[#DFE1E7] flex justify-center items-center gap-2 bg-white">
          <div className="flex-1 text-center text-[#3D424A] text-sm font-['PeydaWeb'] font-light underline leading-[21px] tracking-wide break-word cursor-pointer">
            مشاهده همه اعلان ها
          </div>
        </div>
      </div>
