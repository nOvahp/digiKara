        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4" dir="rtl">
            ...
            <div className="self-stretch px-6 py-4 border-b border-[#DFE1E7] flex justify-between items-center bg-white">
                 <div className="flex items-center gap-2">
                    ...
                    <div className="text-[#0D0D12] text-16 font-['PeydaWeb'] font-light leading-24 tracking-wide break-word">اعلان ها</div>
                 </div>
                <div className="text-[#3D424A] text-sm font-['PeydaWeb'] font-light underline leading-[21px] tracking-wide break-word cursor-pointer">علامت زدن همه به عنوان خوانده شده</div>
            </div>
            ...
            <div className="px-6 py-4 flex flex-col justify-start items-start">
                    ...
                    <div className="flex-1 flex flex-col justify-start items-start gap-1">
                        <div className="self-stretch flex flex-col justify-start items-end gap-2">
                             <div className="self-stretch flex justify-between items-center">
                                <div className="text-right text-[#0D0D12] text-sm font-['PeydaWeb'] font-light leading-[21px] tracking-wide break-word">سفارش جدید دریافت شد</div>
                ...
                <div className="self-stretch py-4 flex justify-start items-start gap-3 border-b border-dashed border-[#E5E7EB]">
                    ...
                    <div className="flex-1 flex flex-col justify-start items-start gap-1">
                        <div className="self-stretch flex flex-col justify-start items-start gap-2">
                            <div className="self-stretch flex justify-between items-center">
                                <div className="text-[#0D0D12] text-sm font-['PeydaWeb'] font-light leading-[21px] tracking-wide break-word">گزارش فروش ماهانه ایجاد شد</div>
                                <div className="w-2 h-2 bg-[#DF1C41] rounded-full" />
                            </div>
                            <div className="self-stretch text-right text-[#666D80] text-xs font-['PeydaWeb'] font-light leading-[18px] tracking-wide break-word">
                ...
                <div className="self-stretch py-4 flex justify-start items-start gap-3 border-b border-dashed border-[#E5E7EB]">
                    ...
                    <div className="flex-1 flex flex-col justify-start items-start gap-1">
                        <div className="self-stretch flex flex-col justify-start items-start gap-2">
                            <div className="self-stretch flex justify-between items-center">
                                <div className="text-[#0D0D12] text-sm font-['PeydaWeb'] font-light leading-[21px] tracking-wide break-word">هشدار کمبود موجودی</div>
                                <div className="w-2 h-2 bg-[#DF1C41] rounded-full" />
                            </div>
                            <div className="self-stretch text-right text-[#666D80] text-xs font-['PeydaWeb'] font-light leading-[18px] tracking-wide break-word">
                ...
                <div className="self-stretch py-4 flex justify-start items-start gap-3">
                    ...
                    <div className="flex-1 flex flex-col justify-start items-start gap-1">
                        <div className="self-stretch flex flex-col justify-start items-start gap-2">
                            <div className="self-stretch flex justify-start items-center">
                                <div className="text-[#0D0D12] text-sm font-['PeydaWeb'] font-light leading-[21px] tracking-wide break-word">محصول به روز شد</div>
                            </div>
                            <div className="self-stretch text-right text-[#666D80] text-xs font-['PeydaWeb'] font-light leading-[18px] tracking-wide break-word">
            ...
            <div className="self-stretch px-6 py-4 border-t border-[#DFE1E7] flex justify-center items-center gap-2 bg-white">
                <div className="flex-1 text-center text-[#3D424A] text-sm font-['PeydaWeb'] font-light underline leading-[21px] tracking-wide break-word cursor-pointer">مشاهده همه اعلان ها</div>
            </div>
        </div>
        </div>
    );
