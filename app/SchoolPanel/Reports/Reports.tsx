...
const ReportsPage = () => {
    ...
    const forecastData = [
        ...
        { name: 'اردیبهشت', value: 30 },
        { name: 'خرداد', value: 45 },
        { name: 'تیر', value: 48 },
        { name: 'مرداد', value: 55 },
        { name: 'شهریور', value: 85 },
    ];

    return (
        <div className="w-full h-full pt-4 pb-8 px-0 flex flex-col justify-start items-center gap-6" dir="rtl">
                ...
                <div className="flex items-center gap-3">
                     <div className="relative">
                        <div className="w-10 h-10 rounded-full overflow-hidden">
                         ...
                         <div className="absolute bottom-[-2px] left-[-2px] w-[13px] h-[13px] bg-[#64B327] rounded-full border-2 border-[#FFD369] shadow-sm"></div>
                     </div>
                     <div className="flex flex-col items-start gap-1">
                         <div className="text-[#222831] text-16 font-['PeydaFaNum'] font-extrabold leading-[22.4px]">هنرستان هنرهای زیبا</div>
                         <div className="text-[#61656B] text-12 font-['PeydaFaNum'] font-extrabold">ابهر، زنجان</div>
                     </div>
                </div>
                {/* Placeholder for left side icons if needed */}
                <div></div>
            </div>
            ...
            {/* Smart Suggestions (Kept from previous as it fits dashboard, optional) */}
            {/* <div className="flex flex-col gap-4 w-full mt-4">...</div> */}

             {/* Activity & Sales Chart (Kept) */}
            ...
            <div className="flex flex-col gap-4 w-full mt-4">
                <div className="flex justify-between items-center w-full">
                    <h2 className="text-[#222831] text-lg font-['PeydaFaNum'] font-extrabold leading-[25.2px]">پروژه ها</h2>
                </div>
                ...
                {/* Active Orders List */}
                <div className="w-full bg-white shadow-[0px_2px_4px_-1px_rgba(13,13,18,0.06)] rounded-xl outline outline-1 outline-[#DFE1E7] -outline-offset-1 flex flex-col justify-start items-end overflow-hidden">
                    ...
                    <div className="w-full overflow-x-auto no-scrollbar">
                        <div className="min-w-[1000px] flex flex-col">
                            ...
                            {/* Table Header */}
                            <div className="w-full h-10 bg-[#F6F8FA] border-b border-[#DFE1E7] flex justify-end items-center px-2">
                            ...
                            {Array.from({ length: 10 }).map((_, idx) => {
                                ...
                                return (
                                <div key={idx} onClick={() => setIsProductPopUpOpen(true)} className="w-full h-16 border-b border-[#DFE1E7] flex justify-end items-center px-2 hover:bg-gray-50 transition-colors cursor-pointer group">
