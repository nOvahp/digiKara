...
const formSchema = z.object({
  ...
  description: z
    .string()
    .min(1, 'لطفا توضیحات را وارد کنید')
    ...
    <div className="w-full min-h-screen flex flex-col items-center pb-10" dir="rtl">
        ...
        <div className="w-full px-4 flex justify-between items-center">
          <div className="flex items-center gap-2 justify-center">
            ...
            <div className="px-2 py-0.5 bg-gradient-to-r from-[#8B5CF6] to-[#3B82F6] rounded-full flex items-center gap-1 shadow-sm">
              ...
              <span className="text-[10px] font-bold text-white font-['PeydaWeb'] tracking-wider">
                AI
              </span>
            </div>
          </div>
      ...
      <div className="w-full max-w-[440px] px-0 py-6 flex flex-col gap-6">
          ...
          <input
            ...
            className={cn(
              ...
              errors.name
                ...
                : 'border-[#DFE1E7] focus:border-[#FDD00A]',
            )}
          />
          {errors.name && (
            <span className="text-red-500 text-xs font-['PeydaWeb']">{errors.name.message}</span>
          )}
        </div>
          ...
          <div className="w-full h-12 p-1 bg-white rounded-xl border border-[#E5E5E5] shadow-sm flex items-center">
            <div
              ...
              className={cn(
                ...
                category === 'product'
                  ? 'bg-[#FDD00A]/10 border border-[#FDD00A]'
                  : 'text-[#666D80]',
              )}
            >
              <span
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <div
            className={cn(
              ...
              errors.description
                ? 'border-red-500'
                : 'border-[#DFE1E7] focus-within:border-[#FDD00A]',
            )}
          >
            <textarea
          ...
          {errors.description && (
            <span className="text-red-500 text-xs font-['PeydaWeb']">
        ...
        <div className="w-full flex flex-col gap-2 relative">
          ...
          {errors.manager && (
            <span className="text-red-500 text-xs font-['PeydaWeb']">{errors.manager.message}</span>
          )}
        </div>
      </div>
