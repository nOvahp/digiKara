...
const Timche = () => {
  ...
  return (
    <div
      className="w-full min-h-screen pb-12 pt-0 px-0 flex flex-col justify-start items-center gap-6"
      dir="rtl"
    >
      {/* Header */}
      <div className="w-full pt-6 flex flex-col gap-3">
        <div className="w-full flex justify-between items-center">
          ...
          <div
            onClick={() => router.back()}
            className="w-10 h-10 bg-white rounded-full border border-[#DFE1E7] flex items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors"
          >
        ...
        {/* Add Timche Button */}
        <div
          onClick={() => router.push('/SchoolPanel/Timche/New')}
      ...
      <div className="flex gap-3 w-full">
        ...
        <div className="flex-1 p-4 bg-white shadow-[0px_2px_4px_-1px_rgba(13,13,18,0.06)] rounded-xl outline outline-1 outline-[#DFE1E7] -outline-offset-1 flex flex-col justify-start items-start gap-2.5 relative">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 -bottom-3 bg-[#DDF3EF] rounded-[36px] flex justify-center items-center px-2 py-[1px] gap-0.5">
            <div className="text-[#28806F] text-[10px] font-num-medium font-semibold leading-[15px] tracking-wide break-word whitespace-nowrap">
              +{toFarsiNumber(3.6)}٪{' '}
            </div>
          </div>
        </div>
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              <div className="self-stretch flex justify-start items-start gap-2.5">
                ...
                <div
                  className={`flex-1 h-[35px] px-6 py-3 rounded-xl border border-[#DFE1E7] flex justify-center items-center gap-2.5 cursor-pointer ${
