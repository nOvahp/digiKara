      ...
      <div className="w-full max-w-[440px] px-0 py-6 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            />
            {errors.grade && (
              <span className="text-red-500 text-xs font-['PeydaWeb']">{errors.grade.message}</span>
            )}
          </div>
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            />
            {errors.skill && (
              <span className="text-red-500 text-xs font-['PeydaWeb']">{errors.skill.message}</span>
            )}
          </div>
        </div>
      </div>
