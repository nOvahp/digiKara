...
const NewTimche3 = () => {
    ...
    const togglePermission = (role: 'manager' | 'student', permission: 'content' | 'price' | 'order') => {
        setMatrix(prev => ({
            ...prev,
            [role]: {
                ...prev[role],
        ...
        <div className="w-full min-h-screen flex flex-col items-center pb-30 relative" dir="rtl">
            ...
            <div className="w-full max-w-[440px] px-0 py-6 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2 max-h-[300px] overflow-y-auto px-1 custom-scrollbar">
                    {members.map((member) => (
                        <div key={member.id} className="w-full h-[61px] p-2 pr-[14px] bg-white rounded-xl border border-[#DCE4E8] flex items-center justify-between shrink-0">
                ...
                <div className="w-full flex flex-col gap-3 pt-3">
                    ...
                    <div className="w-full bg-white rounded-xl border border-[#DFE1E7] overflow-hidden shadow-[0px_2px_4px_-1px_rgba(13,13,18,0.06)]">
                        ...
                        <div className="w-full h-10 bg-[#F6F8FA] border-b border-[#DFE1E7] flex">
                             <div className="w-[97px] flex items-center justify-start px-3 text-[#666D80] text-sm font-['PeydaWeb'] font-semibold border-l-[1px] border-[#DFE1E7] border-opacity-50">نقش</div>
                             <div className="flex-1 flex items-center justify-center text-[#666D80] text-sm font-['PeydaWeb'] font-semibold border-l-[1px] border-[#DFE1E7] border-opacity-50">سفارش</div>
                             <div className="flex-1 flex items-center justify-center text-[#666D80] text-sm font-['PeydaWeb'] font-semibold border-l-[1px] border-[#DFE1E7] border-opacity-50">قیمت</div>
                        ...
                        <div className="w-full h-16 border-b border-[#DFE1E7] flex">
                             ...
                             <div onClick={() => togglePermission('manager', 'order')} className="flex-1 flex items-center justify-center border-l-[1px] border-[#DFE1E7] border-opacity-50 cursor-pointer">
                                {matrix.manager.order ? (
                                    <div className="w-5 h-5 relative">
                                        <div className="absolute inset-0 border-[1.25px] border-[#0A0A0A] rounded-[5px]" />
                                        <Check className="w-4 h-4 text-[#0A0A0A] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[60%]" strokeWidth={3} />
                                    </div>
                                ) : <div className="text-sm">-</div>}
                             </div>
                             <div onClick={() => togglePermission('manager', 'price')} className="flex-1 flex items-center justify-center border-l-[1px] border-[#DFE1E7] border-opacity-50 cursor-pointer">
                             ...
                             <div onClick={() => togglePermission('manager', 'content')} className="flex-1 flex items-center justify-center cursor-pointer">
                         ...
                         <div className="w-full h-16 flex">
                             ...
                             <div onClick={() => togglePermission('student', 'price')} className="flex-1 flex items-center justify-center border-l-[1px] border-[#DFE1E7] border-opacity-50 cursor-pointer">
                             ...
                             <div onClick={() => togglePermission('student', 'content')} className="flex-1 flex items-center justify-center cursor-pointer">
                    ...
                    <div className="bg-white w-full max-w-[400px] rounded-2xl p-4 flex flex-col gap-4 max-h-[80vh]">
                        ...
                        <div className="flex flex-col gap-2 overflow-y-auto custom-scrollbar">
                            {availableUsers.map((user) => (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                         <div className={cn("w-10 h-10 rounded-lg flex items-center justify-center text-white", user.color)}>
