...
const commentsData: Comment[] = [
  {
    id: 1,
    user: 'مهدی احمدی',
    product: 'عسل آویشن ارگانیک',
    review: 'طعم بی‌نظیر و خواص فراوان!',
    date: '21 آبان 1404',
    status: 'Published',
  ...
  },
  {
    ...
    user: 'احسان یزدی',
    product: 'عسل آویشن ارگانیک',
    review: 'مناسب برای تقویت سیستم ایمنی!',
    date: '23 آبان 1404',
    status: 'Published',
    statusText: 'منتشر شده',
    rating: 5,
  },
  {
    ...
    user: 'سارا نیک‌فر',
    product: 'عسل آویشن ارگانیک',
    review: 'بهترین انتخاب برای صبحانه!',
    date: '24 آبان 1404',
    status: 'Published',
    statusText: 'منتشر شده',
    rating: 5,
  },
  {
    ...
    user: 'علی حسینی',
    product: 'عسل آویشن ارگانیک',
    review: 'طبیعی و بدون مواد افزودنی!',
    date: '25 آبان 1404',
    status: 'Published',
    statusText: 'منتشر شده',
    rating: 5,
  },
  {
    id: 6,
    user: 'نرگس رستمی',
    product: 'موم عسل طبیعی',
    review: 'سرشار از ویتامین‌ها و مواد معدنی!',
    date: '26 آبان 1404',
    status: 'Published',
    statusText: 'منتشر شده',
    rating: 5,
  },
  {
    ...
    user: 'امیرعباس مصلحی',
    product: 'موم عسل طبیعی',
    review: 'درمان طبیعی برای سرماخوردگی!',
    date: '27 آبان 1404',
    status: 'Published',
    statusText: 'منتشر شده',
    rating: 5,
  ...
  },
  {
    id: 9,
    user: 'مینا راد',
    product: 'عصاره چای سبز',
    review: 'خواص شگفت‌انگیز!',
    date: '1 آذر 1404',
    status: 'Approved',
  ...
  },
  {
    id: 10,
    user: 'پیمان مقیمی',
    product: 'روغن زیتون بکر',
    review: 'طبیعی و خالص!',
    date: '5 آذر 1404',
    status: 'Production',
    statusText: 'در حال تولید',
    rating: 5,
  },
  {
    id: 11,
  ...
  },
  {
    id: 12,
    user: 'رضا بختیاری',
    product: 'عصاره آلوئه ورا',
    review: 'مناسب برای تمام سنین!',
    date: '15 آذر 1404',
    status: 'Testing',
    statusText: 'در حال آزمایش',
    rating: 5,
  },
  {
    id: 13,
    user: 'الهام فردوسی',
    product: 'پودر زردچوبه',
    review: 'تقویت‌کننده ایمنی!',
    date: '20 آذر 1404',
    status: 'Approved',
    statusText: 'تأیید شده',
    rating: 5,
  },
  {
    id: 14,
    user: 'بهنام سهرابی',
    product: 'عصاره توت‌فرنگی',
    review: 'حاوی آنتی‌اکسیدان!',
    date: '25 آذر 1404',
    status: 'Published',
    statusText: 'منتشر شده',
    rating: 5,
      ...
      <div className="w-full flex flex-col gap-6">
        <div className="w-full bg-white rounded-xl border border-[#DFE1E7] shadow-[0px_2px_4px_-1px_rgba(13,13,18,0.06)] overflow-hidden flex flex-col">
          ...
          <div className="w-full h-16 px-5 py-2 border-b border-[#DFE1E7] flex justify-between items-center bg-white">
            ...
            <div className="text-[#0D0D12] text-base font-semibold tracking-wide">جدول نظرات</div>
          </div>
              ...
              <div>
                {currentData.map((comment) => {
                  ...
                  return (
                    <div
                      key={comment.id}
                      className="w-full flex items-center px-[9px] border-b border-[#DFE1E7] bg-white hover:bg-gray-50 transition-colors"
                    >
                      {/* Action/More Icon */}
                      ...
                      <div className="flex-1 h-16 px-3 flex items-center justify-center gap-1.5">
                        <div
                          className={`h-5 px-2 py-0.5 rounded-2xl flex items-center gap-1 ${styles.bg}`}
                        >
                          <div className={`w-1.5 h-1.5 rounded-full ${styles.dot}`} />
                          <span className={`text-xs font-num-medium ${styles.text}`}>
                            {comment.statusText}
                          </span>
                        </div>
                      </div>
                      ...
                      {/* Rating */}
                      <div
                        className="flex-1 h-16 px-3 flex items-center justify-start gap-0.5"
                        dir="ltr"
                      >
                        {[...Array(5)].map((_, i) => (
                      ...
                      <div className="w-[248px] h-16 px-3 flex items-center justify-end gap-2.5">
                        <span
                          className="text-[#0D0D12] text-sm font-semibold truncate text-right w-full"
                          dir="rtl"
                        >
                          “{comment.review}”
                        </span>
