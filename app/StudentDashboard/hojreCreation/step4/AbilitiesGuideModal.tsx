...
interface AbilitiesGuideModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export function AbilitiesGuideModal({ isOpen, onClose }: AbilitiesGuideModalProps) {
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          <div className="flex flex-col gap-6 pt-6">
            <p className="text-[#666D80] text-sm font-semibold font-['PeydaWeb'] leading-[28px] tracking-wide text-right">
              هر کاری که توش استادی یا داری یادش می‌گیری رو اینجا بنویس. این کلمات مثل کلمات
              کلیدی (تگ) عمل می‌کنن و به مشتری‌ها نشون میدن که دقیقاً چه پروژه‌هایی رو می‌تونن
              بهت بسپارن.
            </p>
            ...
            <div className="bg-[#FFFBEA] border border-[#FDD00A] rounded-xl p-4">
              <p className="text-[#444] text-sm font-medium leading-[24px] text-right">
                با <span className="text-[#0C1415] font-semibold">ویرگول</span> از هم جداشون کن.
              </p>
            </div>
          </div>
        </div>
