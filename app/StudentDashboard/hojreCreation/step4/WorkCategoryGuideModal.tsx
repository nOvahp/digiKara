...
interface WorkCategoryGuideModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export function WorkCategoryGuideModal({ isOpen, onClose }: WorkCategoryGuideModalProps) {
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          <div className="flex flex-col gap-6 pt-6">
            <p className="text-[#666D80] text-sm font-semibold font-['PeydaWeb'] leading-[28px] tracking-wide text-right">
              تو بازارهای قدیمی، هر شغلی یه کوچه یا راسته‌ی مخصوص خودش رو داشت (مثل راسته
              مسگرها!). اینجا هم راسته‌ی کاری، همون رشته و حوزه اصلی مهارت توئه. راسته‌ت رو
              انتخاب کن تا مشتری‌ها راحت‌تر پیدات کنن.
            </p>
          </div>
        </div>
