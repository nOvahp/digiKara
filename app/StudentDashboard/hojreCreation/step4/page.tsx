            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex-1 w-full max-w-md px-4 mt-6 flex flex-col gap-6 overflow-y-auto">
                        ...
                        render={({ field }) => (
                            <Select onValueChange={field.onChange} defaultValue={field.value} dir="rtl">
                                <SelectTrigger className="h-[52px] w-full bg-white rounded-xl border border-[#DFE1E7] text-right font-medium text-[#1A1C1E]">
                                    <SelectValue placeholder="مثلاً: پوشاک، کالای دیجیتال، مواد غذایی" className="placeholder:text-[#DFE1E7] placeholder:font-medium" />
                                </SelectTrigger>
                                <SelectContent className="font-medium" align="end">
                                    <SelectItem value="clothes" className="font-medium">پوشاک</SelectItem>
                                    <SelectItem value="digital" className="font-medium">کالای دیجیتال</SelectItem>
                                    <SelectItem value="food" className="font-medium">مواد غذایی</SelectItem>
                                    <SelectItem value="art" className="font-medium">صنایع دستی</SelectItem>
                                    <SelectItem value="services" className="font-medium">خدمات</SelectItem>
                                </SelectContent>
                            </Select>
                        )}
                    />
                    {errors.workCategory && <span className="text-red-500 text-xs text-right font-medium">{errors.workCategory.message}</span>}
                </div>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Input 
                        ...
                        dir="rtl"
                    />
                     {errors.abilities && <span className="text-red-500 text-xs text-right font-medium">{errors.abilities.message}</span>}
                </div>
                 ...
                 <div className="flex flex-col gap-2">
                    ...
                    <div className="relative w-full h-[52px]">
                     ...
                     {errors.experience && <span className="text-red-500 text-xs text-right font-medium">{errors.experience.message}</span>}
                </div>
