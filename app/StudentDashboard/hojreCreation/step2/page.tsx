      ...
      <div className="flex-1 w-full max-w-md px-4 mt-6 flex flex-col gap-8 overflow-y-auto">
        ...
        <div className="flex flex-col items-end gap-2 text-right">
          ...
          <p className="text-[#707F81] text-xs font-light font-['PeydaWeb'] leading-relaxed w-full">
            هدف این پلتفرم تنها کسب درآمد نیست؛ بلکه تمرینِ مسئولیت‌پذیری، مدیریت مالی و مهارت‌های
            کسب‌وکار در محیطی امن است. تمام کاربران ملزم به رعایت اصول اخلاقی و قانونی زیر هستند.
          </p>
        </div>
        ...
        <div className="flex flex-col items-end gap-2 text-right">
          ...
          <div className="text-[#707F81] text-xs font-light font-['PeydaWeb'] leading-relaxed w-full">
            ...
            کاربر باید تصویر کارت دانش‌آموزی یا گواهی اشتغال به تحصیل معتبر سال جاری را بارگذاری
            کند.
            <br />
            <span className="font-semibold text-[#707F81]">رضایت ولی قانونی: </span>
            برای دانش‌آموزان زیر ۱۸ سال، فعالیت فروشگاه منوط به تایید الکترونیکی (OTP) یا بارگذاری
            فرم رضایت‌نامه توسط ولی قانونی (پدر یا جد پدری) است.
            <br />
            <span className="font-semibold text-[#707F81]">حساب بانکی: </span>
            تسویه حساب‌های مالی تنها به حساب بانکی به نام دانش‌آموز (در صورت داشتن کارت بانکی مستقل)
            یا حساب تایید شده ولی قانونی او واریز می‌شود.
          </div>
        </div>
        ...
        <div className="flex flex-col items-end gap-2 text-right">
          ...
          <div className="text-[#707F81] text-xs font-light font-['PeydaWeb'] leading-relaxed w-full">
            ...
            صنایع دستی، محصولات هنری، لوازم تحریر، جزوات آموزشی (تألیف خود دانش‌آموز)، خدمات
            فریلنسری (طراحی لوگو، تایپ)، و کالاهای بازرگانی.
            <br />
            <span className="font-semibold text-[#707F81]">کالاهای ممنوعه: </span>
            هرگونه کالا مغایر با قوانین جمهوری اسلامی ایران (مشروبات، سلاح، تصاویر نامناسب و...).
            فروش تقلب، حل‌المسائلِ تکالیف مدرسه یا هر خدمتی که به فرآیند آموزش آسیب بزند. کالاهای
            دیجیتال ناقض کپی‌رایت (فروش فیلم و نرم‌افزار کرک شده). مواد خوراکی بدون بسته‌بندی
            بهداشتی یا مجوز (مگر خوراکی‌های خانگی خشک با رعایت شیوه‌نامه بهداشتی پلتفرم).
          </div>
        </div>
        ...
        <div className="flex flex-col items-end gap-2 text-right">
          <h3 className="text-[#3C5A5D] text-[15px] font-semibold font-['PeydaWeb'] text-right w-full">
            چارچوب تولید محتوا و اخلاق حرفه‌ای
          </h3>
          <div className="text-[#707F81] text-xs font-light font-['PeydaWeb'] leading-relaxed w-full">
            ...
            تمام تصاویر محصول یا مدل‌ها باید با شئونات اسلامی و قوانین کشور مطابقت داشته باشد.
            استفاده از تصاویر ابزاری یا نامتعارف ممنوع است.
            <br />
            <span className="font-semibold text-[#707F81]">ادبیات گفتاری: </span>
            هرگونه توهین، تمسخر، یا استفاده از کلمات رکیک در بخش نظرات، چت با مشتری و توضیحات محصول
            منجر به مسدود شدن فروشگاه می‌شود.
            <br />
            <span className="font-semibold text-[#707F81]">صداقت در تبلیغ: </span>
            طبق قانون حمایت از حقوق مصرف‌کننده، توضیحات محصول باید دقیقاً مطابق با واقعیت باشد.
            اغراقِ دروغین (مثلاً: &quot;ضد ضربه بودن&quot; برای کالایی که نیست) تخلف محسوب می‌شود.
          </div>
        </div>
        ...
        <div className="flex flex-col items-end gap-2 text-right">
          <h3 className="text-[#3C5A5D] text-[15px] font-semibold font-['PeydaWeb'] text-right w-full">
            قوانین مالی و تعهدات فروش
          </h3>
          <div className="text-[#707F81] text-xs font-light font-['PeydaWeb'] leading-relaxed w-full">
            <span className="font-semibold text-[#707F81]">کارمزد پلتفرم: </span>
            درصدی از هر تراکنش (مثلاً ۵٪) به عنوان هزینه زیرساخت و آموزش کسر می‌شود. (این مورد باید
            شفاف به کاربر نمایش داده شود).
            <br />
            <span className="font-semibold text-[#707F81]">تسویه حساب: </span>
            مبلغ فروش تا زمان رسیدن کالا به دست مشتری و تایید او، نزد پلتفرم به امانت می‌ماند
            (پرداخت امن).
            <br />
            <span className="font-semibold text-[#707F81]">قوانین مرجوعی: </span>
            دانش‌آموز موظف است طبق قانون تجارت الکترونیک، تا ۷ روز کالای معیوب یا مغایر با توضیحات
            را پس بگیرد.
          </div>
        </div>
        ...
        <div className="flex flex-col items-end gap-2 text-right">
          ...
          <div className="text-[#707F81] text-xs font-light font-['PeydaWeb'] leading-relaxed w-full">
            ...
            برای ارتقای سطح فروشگاه (مثلاً گرفتن تیک آبی یا ویترین اول)، دانش‌آموز باید ویدئوهای
            آموزشی کوتاه پلتفرم (مثل نحوه قیمت‌گذاری، نحوه بسته‌بندی) را تماشا کند.
          </div>
        </div>
        ...
        <div className="flex flex-col items-end gap-2 text-right">
          ...
          <div className="text-[#707F81] text-xs font-light font-['PeydaWeb'] leading-relaxed w-full">
            ...
            دانش‌آموزان حق ندارند شماره تماس، آدرس یا اطلاعات شخصی خریداران را در جایی غیر از فرآیند
            ارسال کالا ذخیره یا منتشر کنند.
            <br />
            <span className="font-semibold text-[#707F81]">ممنوعیت معامله خارج از پلتفرم: </span>
            هرگونه هدایت مشتری به دایرکت اینستاگرام یا کارت‌به‌کارت برای فرار از کارمزد، منجر به
            بسته شدن فروشگاه می‌شود (چون امنیت خرید را از بین می‌برد).
          </div>
        </div>
