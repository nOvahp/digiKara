    ...
    >
      <div className="flex justify-between items-start">
        <div className="flex flex-col gap-2">
          ...
          <span className="text-[#0D0D12] text-2xl font-bold font-['PeydaFaNum'] tracking-tight">
            {value}
          </span>
        </div>
        <div
      ...
      {trend && (
        <div className="flex items-center gap-2 text-xs pt-2">
          <span
            className={cn(
              "px-2.5 py-0.5 rounded-full flex items-center gap-1 font-['PeydaFaNum'] font-medium",
              trendBgColor,
            )}
          >
            {trend}
