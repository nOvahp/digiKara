  ...
  const handleChange = (field: string, value: string) => {
    ...
    if (field === 'price') {
      ...
      if (!isNaN(numericPrice) && numericPrice > 0) {
        // Calculate 10% fee
        const fee = Math.floor(numericPrice * 0.1);
    ...
    <div className="w-full bg-white rounded-2xl border border-[#DFE1E7] p-3 md:p-5 flex flex-col gap-5 shadow-sm">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="h-[52px] px-2 md:px-3 bg-white rounded-xl border border-[#DFE1E7] flex items-center gap-2 md:gap-3 focus-within:border-[#FDD00A] transition-colors">
          ...
          <div className="text-[#0D0D12] text-sm font-semibold font-['PeydaWeb'] whitespace-nowrap">
            ریال
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-2.5">
          ...
          <div className="flex justify-between items-center text-sm flex-wrap gap-2">
            <span className="text-[#666D80] font-semibold font-['PeydaWeb']">
        ...
        <div className="flex justify-center items-center gap-1 text-sm">
          ...
          <span className="text-[#0D0D12] font-semibold underline cursor-pointer font-['PeydaWeb']">
            اینجا کلیک کنید
          </span>
        </div>
      </div>
