...
export function CategoryTagsForm({
  defaultValues = {},
  values,
  onChange,
  categories = [],
  ...
  return (
    <div className="w-full bg-white rounded-2xl border border-[#DFE1E7] p-5 flex flex-col gap-5 shadow-sm">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div
          className="min-h-[52px] px-3 bg-white rounded-xl border border-[#DFE1E7] flex items-center relative flex-wrap py-2 gap-2 focus-within:border-[#FDD00A] transition-colors"
          dir="rtl"
        >
          ...
          <div className="flex gap-2 flex-wrap z-20 pointer-events-none">
            {currentTags.map((tag) => (
              <div
                key={tag}
                className="flex items-center gap-1 px-2 py-0.5 border border-[#DFE1E7] rounded-lg bg-white pointer-events-auto"
              >
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          dir="rtl"
        />
        <div className="text-[#818898] text-sm font-light text-right font-['PeydaWeb']">
