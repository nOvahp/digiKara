...
export function NewProductPage5({ onClose, onNext, onStepClick, formData, updateFormData }: NewProductPage5Props) {
    ...
    // Mock available tags
    const availableTags = [
        "ارگانیک", "عسل طبیعی", "ویژه", "محلی", "بدون قند", "تخفیفی", "کوهی", "دست‌ساز"
    ];
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-[375px] max-h-[90vh] bg-white rounded-2xl shadow-xl flex flex-col overflow-hidden">
                ...
                >
                     ...
                     <StepItem step="5" label="دسته بندی و برچسب ها" isActive={true} onClick={() => {}} ref={activeStepRef} />
                     <div className="w-8 border-t-2 border-dashed border-[#DFE1E7] mx-1 shrink-0" />
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <div className="flex flex-wrap gap-2 flex-1 justify-start">
                                    {tags.length > 0 ? (
                                        tags.map(tag => (
                                            <div key={tag} className="h-6 pl-1 pr-2 bg-white rounded border border-[#DFE1E7] flex items-center gap-1">
                                        ...
                                        <span className="text-[#818898] text-base font-light font-['PeydaWeb']">انتخاب کنید...</span>
                                    )}
                                </div>
