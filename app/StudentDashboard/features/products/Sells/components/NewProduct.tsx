      ...
      <div className="relative w-[375px] max-h-[90vh] bg-white rounded-2xl shadow-xl flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto w-full p-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            {(formData.images || []).length > 0 ? (
              ...
              >
                <div className="text-center px-4">
                  <span className="text-[#666D80] text-base font-light font-['PeydaWeb'] leading-normal tracking-wide">
                    فایل های خود را بکشید و رها کنید یا{' '}
                  </span>
                  <span className="text-[#666D80] text-base font-semibold font-['PeydaWeb'] leading-normal tracking-wide">
                    کلیک کنید
                  </span>
                </div>
              </div>
            ...
            {errors.images && (
              <span className="text-red-500 text-xs text-right font-medium">{errors.images}</span>
            )}
            <input
              type="file"
              ref={fileInputRef}
