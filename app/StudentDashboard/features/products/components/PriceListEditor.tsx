        ...
        <div className="w-full flex flex-col gap-4 p-5 bg-white rounded-2xl border border-[#DFE1E7] shadow-sm">
            ...
            {isAdding && (
                 <div className="bg-white p-4 rounded-xl border border-[#FDD00A] flex flex-col gap-4 shadow-sm relative">
                     ...
                     <div className="text-sm font-medium text-[#0D0D12] font-['PeydaWeb'] text-right">افزودن قیمت جدید</div>
                     
                     {/* Title & Type */}
                     <div className="flex flex-col md:flex-row gap-4">
                        <div className="relative w-full md:w-1/4">
                            <div className="text-right text-[#666D80] text-sm font-medium font-['PeydaWeb'] mb-2">ویژگی</div>
                        ...
                        <div className="flex-1 flex flex-col gap-2">
                            <div className="text-right text-[#666D80] text-sm font-medium font-['PeydaWeb']">عنوان</div>
                            <input 
                     ...
                     <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                         <div className="flex flex-col gap-2">
                            <div className="text-right text-[#666D80] text-sm font-medium font-['PeydaWeb']">تخفیف %</div>
                            <input 
                         ...
                         <div className="flex flex-col gap-2">
                            <div className="text-right text-[#666D80] text-sm font-medium font-['PeydaWeb']">موجودی</div>
                            <input 
                         ...
                         <div className="col-span-2 lg:col-span-1 flex flex-col gap-2">
                            <div className="text-right text-[#666D80] text-sm font-medium font-['PeydaWeb']">هشدار موجودی</div>
                            <input 
                                className="w-full h-[52px] px-3 rounded-xl border border-[#DFE1E7] text-right font-num-medium font-['PeydaFaNum'] text-sm outline-none focus:border-[#FDD00A]"
                     ...
                     >
                         <span className="text-[#666D80] text-sm font-medium font-['PeydaWeb']">افزودن ویژگی ها</span>
                        ...
                        <div key={price.id} className="bg-white p-4 rounded-xl border border-[#DFE1E7] flex flex-col gap-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="w-1/3 flex flex-col gap-1">
                                    <label className="text-xs text-gray-500 font-medium font-['PeydaWeb']">تخفیف %</label>
                                    <input 
                                        className="w-full h-[52px] px-3 rounded-xl border border-[#DFE1E7] text-center font-num-medium font-['PeydaFaNum'] text-sm outline-none focus:border-[#FDD00A]"
                            ...
                            <div className="flex gap-2">
                                <div className="flex-1 flex flex-col gap-1">
                                    <label className="text-xs text-gray-500 font-medium font-['PeydaWeb']">موجودی</label>
                                    <input 
                                        className="w-full h-[52px] px-3 rounded-xl border border-[#DFE1E7] text-right font-num-medium font-['PeydaFaNum'] text-sm outline-none focus:border-[#FDD00A]"
                                ...
                                <div className="flex-1 flex flex-col gap-1">
                                    <label className="text-xs text-gray-500 font-medium font-['PeydaWeb']">هشدار موجودی</label>
                                    <input 
                                        className="w-full h-[52px] px-3 rounded-xl border border-[#DFE1E7] text-right font-num-medium font-['PeydaFaNum'] text-sm outline-none focus:border-[#FDD00A]"
