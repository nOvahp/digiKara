  ...
  return (
    <div className="w-full inline-flex flex-col justify-start items-start gap-2" dir="rtl">
      ...
      <div className="self-stretch flex flex-col justify-center items-start gap-2">
        {/* Add New Product */}
        <div
          onClick={() => router.push('/StudentDashboard/Sells?new=true')}
          className="self-stretch py-1 pl-4 pr-1 bg-[#F7C61A] rounded-lg justify-start items-center gap-2 inline-flex cursor-pointer hover:opacity-90 transition-opacity"
        >
