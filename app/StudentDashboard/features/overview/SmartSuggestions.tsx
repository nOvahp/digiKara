              ...
              <CarouselItem key={item.id} className="pl-4 basis-[85%] sm:basis-[300px]">
                <div className="h-full">
                  <Card className="border border-[#DFE1E7] shadow-sm h-full rounded-xl overflow-hidden hover:shadow-md transition-shadow duration-200">
                    <CardContent
                      className="px-4 flex flex-col gap-3 h-full justify-between bg-white text-right"
                      dir="rtl"
                    >
                      <div className="flex flex-col gap-3 items-start">
                        {/* Icon */}
                        <div
                          className={`w-10 h-10 rounded-full flex justify-center items-center ${item.color}`}
                        >
                          {item.icon}
                        </div>
