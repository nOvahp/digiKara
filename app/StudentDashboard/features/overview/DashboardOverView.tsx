    ...
    return (
        <div className="w-full flex flex-col gap-3 mb-6" dir="rtl">
            ...
            <div className="w-full flex justify-between items-center">
                ...
                <div className="text-[#61656B] text-[12px] font-num-medium">
                    10 مهر 1404
                </div>
            </div>
                ...
                <div className="w-full flex gap-3">
                    ...
                    <div className="flex-1 bg-white shadow-sm rounded-lg p-3.5 flex flex-col justify-center items-center gap-3 min-h-[110px]">
                        <div className="flex flex-col items-center gap-1">
                            ...
                            <div className="text-[#64B327] text-[18px] font-num-medium leading-[25.2px]">
                                فعال
                            </div>
                        </div>
                        <div className="text-[#222831] text-[12px] font-num-medium">
                            وضعیت حجره
                        </div>
                    </div>
                    <div className="flex-1 bg-white shadow-sm rounded-lg p-3.5 flex flex-col justify-center items-center gap-3 min-h-[110px]">
                        <div className="flex flex-col items-center gap-1">
                            ...
                            <div className="text-[#393E46] text-[20px] font-num-medium leading-7">
                                3
                            </div>
                        </div>
                        <div className="text-[#222831] text-[12px] font-num-medium">
