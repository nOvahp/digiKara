...
export function OrderTable({ 
    ...
    const isAllSelected = currentOrders.length > 0 && currentOrders.every(item => selectedOrderIds.includes(item.id));
                ...
                <div className="w-full overflow-x-auto">
                    ...
                    <thead className="bg-[#F9FAFB] border-b border-[#E5E7EB]">
                        <tr>
                            ...
                            <th className="px-6 py-4 text-[#666D80] font-medium text-sm font-['PeydaWeb'] min-w-[280px]">محصول</th>
                            <th className="px-6 py-4 text-[#666D80] font-medium text-sm font-['PeydaWeb'] text-center whitespace-nowrap">تعداد</th>
                            <th className="px-6 py-4 text-[#666D80] font-medium text-sm font-['PeydaWeb'] text-center whitespace-nowrap">مبلغ (ریال)</th>
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex flex-col gap-1 min-w-0">
                                                    <span className="text-[#0D0D12] font-semibold font-['PeydaWeb'] truncate" title={order.productName}>
                                                        {order.productName}
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <span className="text-[#0D0D12] font-bold font-['PeydaFaNum'] text-sm">
                                                {toFarsiNumber(order.amount?.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") || '0')}
                                            </span>
                                        </td>
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <div className="flex justify-center">
                                                <div className={`h-5 px-2 py-0.5 rounded-2xl flex items-center gap-1 max-w-full ${styles.bg}`}>
                                                    ...
                                                    <span className={`text-xs font-['PeydaFaNum'] font-normal truncate ${styles.text}`}>{order.statusText}</span>
                                                </div>
                                            </div>
                                        </td>
