        ...
        >
            <div className="w-full flex justify-between items-center px-4">
                ...
                <Link href="/StudentDashboard" className={getItemClasses(isActive('/StudentDashboard') || isActive('/StudentDashboard/'))}>
                    <Home className={cn("w-6 h-6", getIconColor(isActive('/StudentDashboard') || isActive('/StudentDashboard/')))} strokeWidth={1.5} />
                ...
                <Link href="/StudentDashboard/Sells" className={getItemClasses(isActive('/StudentDashboard/Sells'))}>
                    <Store className={cn("w-6 h-6", getIconColor(isActive('/StudentDashboard/Sells')))} strokeWidth={1.5} />
