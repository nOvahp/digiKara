            ...
            <div className="flex-1 flex flex-col justify-start items-start gap-1.5">
                ...
                <div className="self-stretch inline-flex justify-start items-center gap-1.5">
                    <div className="text-right">
                        ...
                        <span className="text-[#0F172A] text-sm font-['MeemFaNum'] font-medium leading-[21.70px]">5</span>
                ...
                <div className="self-stretch flex justify-center items-center gap-1.5">
                    ...
                    {/* Bar Track */}
                    <div className="flex-1 h-2 bg-[#E0E0E0] rounded-[64px] overflow-hidden flex justify-start items-center relative" dir="ltr">
                ...
                <div className="self-stretch pt-4 flex justify-between items-start gap-1.5">
                    ...
                    <div className="w-[50px] flex flex-col justify-start items-center gap-1.5">
                        ...
                        <div className="w-[49px] text-center text-[#888B90] text-[10px] font-['MeemFaNum'] font-medium leading-[15.50px] break-words">
                            فروشنده برتر
                        </div>
                    </div>
                    ...
                    <div className="w-[50px] flex flex-col justify-start items-center gap-1.5">
                        ...
                        <div className="text-center text-[#888B90] text-[10px] font-['MeemFaNum'] font-medium leading-[15.50px] break-words">
                            ۱0۰ سفارش
                        </div>
                    </div>
