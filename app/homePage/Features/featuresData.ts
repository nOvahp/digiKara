...
export const featuresData: Feature[] = [
  {
    ...
    description: 'مهارت های کاربردی، موثر و مورد نیاز بازار کار به دانش آموزان آموزش داده می شود.',
    image: featureCard1,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: 'کارفرمایان به نیروی کار ماهر و آموزش‌دیده دسترسی پیدا می‌کنند',
    image: featureCard3,
  },
  {
    id: 4,
    title: 'فروشگاه اختصاصی',
    description: 'مدارس‌ها فرآیندهای مالی و آموزشی خود را به‌صورت شفاف مدیریت نمایند.',
    image: featureCard1,
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description: 'نهادهای مالی می‌توانند از پروژه‌های تولیدی مدارس‌ها حمایت کنند.',
    image: featureCard1,
  },
  {
    id: 7,
    title: 'بخش لجستیک',
    description: 'شرکت‌های حمل‌ونقل و توزیع می‌توانند در این سیستم به حمل و نقل محصولات کمک کنند.',
    image: featureCard1,
  },
];
