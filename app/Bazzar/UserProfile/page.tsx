...
export default function UserProfilePage() {
    ...
    if (loading) {
        return (
            <div className="w-full h-[100dvh] bg-gray-50/50 flex flex-col items-center relative overflow-hidden" dir="rtl">
                 {/* Header Skeleton */}
                 ...
                 <div className="w-full max-w-[440px] flex-1 p-6 flex flex-col gap-6 overflow-hidden">
                    ...
                    {/* Rows Skeleton */}
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="w-full bg-white rounded-2xl p-4 border border-gray-100 shadow-sm space-y-4">
        ...
        return (
            <div className="w-full h-[100dvh] bg-white flex flex-col items-center justify-center gap-6 relative" dir="rtl">
                ...
                <div className="text-center space-y-2">
                    <h3 className="text-[#0C1415] text-lg font-['PeydaWeb'] font-bold">خطا در دریافت اطلاعات</h3>
                    <p className="text-[#707F81] text-sm font-['PeydaWeb']">متاسفانه مشکلی در بارگذاری پروفایل پیش آمده است.</p>
                </div>
                <button 
                ...
                <div className="w-full flex flex-col items-center gap-5 py-8 relative">
                    ...
                    <div className="relative group cursor-pointer">
                        ...
                        {user.is_info_correct && (
                            <div className="absolute bottom-1 right-1 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md border border-gray-100 z-10" title="تایید شده">
