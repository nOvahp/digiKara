            ...
            <div className="w-full max-w-[440px] flex flex-col gap-0 px-0 pb-12 flex-1 overflow-y-auto no-scrollbar">
                ...
                <div className="flex flex-col gap-4 w-full mb-6">
                    <div className="flex justify-between items-center w-full">
                         <span className="text-[#707F81] text-sm font-['PeydaWeb'] font-semibold align-middle">جزییات سفارش</span>
                    </div>
                ...
                <div className="flex flex-col gap-4 w-full">
                    <div className="flex justify-between items-center w-full mb-2">
                         <span className="text-[#0C1415] text-base font-['PeydaWeb'] font-semibold">وضعیت سفارش</span>
                    </div>
