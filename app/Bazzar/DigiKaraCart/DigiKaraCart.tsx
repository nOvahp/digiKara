...
export default function DigiKaraCart() {
  ...
  return (
    <div
      className="w-full h-[100dvh] flex flex-col items-center relative overflow-hidden bg-white"
      dir="rtl"
    >
      {/* Header */}
      <div className="w-full flex justify-between items-center px-0 py-4 shrink-0">
        <div className="text-[#0C1415] text-base font-['PeydaWeb'] font-semibold">سبد خرید</div>
        <button
          onClick={() => router.back()}
