...
function SearchContent() {
    ...
    const handleSearch = () => {
        if (localQuery.trim()) {
            ...
            router.push(`/Bazzar/Search?q=${encodeURIComponent(localQuery)}&location=${encodeURIComponent(location)}`);
        }
    };

    return (
        <div className="w-full min-h-screen flex flex-col items-center pb-[50px] relative bg-white" dir="rtl">
             {/* Header Fixed Area */}
