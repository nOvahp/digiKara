...
export function NavBar() {
  ...
  return (
    <div className={cn("w-full fixed bottom-0 left-0 right-0 z-50 flex flex-col items-center pointer-events-none", pathname === '/Bazzar' && 'lg:hidden')}>
      <div className="relative w-full max-w-[440px] pointer-events-auto">
        <div className="w-full bg-white shadow-[0px_0px_4px_#E9B443] rounded-t-[20px] flex flex-col justify-center items-center gap-1 pb-2 pt-2">
          <div className="w-full flex justify-between items-center px-4">
            {/* Profile */}
            <Link
              href="/Bazzar/UserProfile"
              className={getItemClasses(isActive('/Bazzar/UserProfile'))}
            >
              <User
                className={cn('w-6 h-6', getIconColor(isActive('/Bazzar/UserProfile')))}
                strokeWidth={1.5}
              />
            ...
            {/* Cart */}
            <Link
              href="/Bazzar/DigiKaraCart"
              className={getItemClasses(isActive('/Bazzar/DigiKaraCart'))}
            >
              <ShoppingBag
                className={cn('w-6 h-6', getIconColor(isActive('/Bazzar/DigiKaraCart')))}
                strokeWidth={1.5}
              />
            ...
            <Link href="/Bazzar" className={getItemClasses(isActive('/Bazzar'))}>
              <Home
                className={cn('w-6 h-6', getIconColor(isActive('/Bazzar')))}
                strokeWidth={1.5}
              />
            ...
            {/* Categories */}
            <Link
              href="/Bazzar/Categories"
              className={getItemClasses(isActive('/Bazzar/Categories'))}
            >
              <LayoutGrid
                className={cn('w-6 h-6', getIconColor(isActive('/Bazzar/Categories')))}
                strokeWidth={1.5}
              />
            ...
            {/* Favorites */}
            <Link
              href="/Bazzar/Favorites"
              className={getItemClasses(isActive('/Bazzar/Favorites'))}
            >
              <Heart
                className={cn('w-6 h-6', getIconColor(isActive('/Bazzar/Favorites')))}
                strokeWidth={1.5}
              />
