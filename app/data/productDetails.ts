...
export const productDetails: Record<number, ProductDetail> = {
    ...
    5001: {
        ...
        images: ["/7e649474-50f6-42f0-b8b4-9532bae40909.jfif"],
    ...
    5003: { id: 5003, title: "انگشتر نقره فیروزه", rating: 4.6, category: "طلا و جواهر", price: "3,200,000 تومان", description: "انگشتر نقره با سنگ فیروزه نیشابور اصل.", images: ["/d460c433-9182-4bf2-8fa0-fe1aa38e7b64.jfif"], colors: [{ name: "نقره ای", hex: "#C0C0C0", id: "silver" }], sizes: ["58", "60"], specs: { "عیار": "925", "سنگ": "فیروزه" }, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 6 },
