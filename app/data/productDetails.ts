...
export const productDetails: Record<number, ProductDetail> = {
    ...
    5002: { id: 5002, title: "آویز طلا انار", rating: 4.7, category: "طلا و جواهر", price: "4,500,000 تومان", description: "پلاک طلا طرح انار مناسب شب یلدا.", images: ["/3.jpg"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 8 },
    5003: { id: 5003, title: "گوشواره مروارید", rating: 4.6, category: "طلا و جواهر", price: "3,200,000 تومان", description: "گوشواره میخ طلا با مروارید پرورشی.", images: ["/1 (2).png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 6 },
