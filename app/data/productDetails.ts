...
export const productDetails: Record<number, ProductDetail> = {
    ...
    101: {
        ...
        images: ["/ProductDetails.png", "/ProductBazzar.png"],
    ...
    1002: { id: 1002, title: "مبل ال کلاسیک", rating: 4.8, category: "صنایع چوبی", price: "8,200,000 تومان", description: "مبل ال شیک و جادار مناسب برای سالن های پذیرایی بزرگ.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 0 },
    1003: { id: 1003, title: "صندلی لهستانی", rating: 4.3, category: "صنایع چوبی", price: "350,000 تومان", description: "صندلی چوبی طرح لهستانی با خم چوب طبیعی.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 5 },
    ...
    1007: { id: 1007, title: "میز جلو مبلی راش", rating: 4.6, category: "صنایع چوبی", price: "1,800,000 تومان", description: "میز جلو مبلی تمام چوب راش با پایه های خراطی.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 20 },
    1008: { id: 1008, title: "تخت خواب دو نفره کینگ", rating: 4.9, category: "صنایع چوبی", price: "6,000,000 تومان", description: "تخت خواب سایز کینگ با لمسه دوزی مخمل در قسمت تاج.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 35 },
    1009: { id: 1009, title: "تخت خواب یک نفره اسپرت", rating: 4.5, category: "صنایع چوبی", price: "3,200,000 تومان", description: "تخت خواب اسپرت مناسب اتاق نوجوان.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 18 },
    1010: { id: 1010, title: "کتابخانه دیواری", rating: 4.3, category: "صنایع چوبی", price: "850,000 تومان", description: "کتابخانه دیواری مدرن و سبک.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 9 },
    1011: { id: 1011, title: "قفسه کتاب ایستاده", rating: 4.6, category: "صنایع چوبی", price: "1,100,000 تومان", description: "قفسه کتاب ایستاده فلز و چوب.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 14 },
    1012: { id: 1012, title: "صندلی اداری طبی", rating: 4.8, category: "صنایع چوبی", price: "2,500,000 تومان", description: "صندلی اداری با رعایت اصول ارگونومی برای جلوگیری از کمردرد.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 28 },
    1013: { id: 1013, title: "میز مدیریت", rating: 4.7, category: "صنایع چوبی", price: "5,500,000 تومان", description: "میز مدیریت با پنل چرمی و طراحی لاکچری.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 22 },
    1014: { id: 1014, title: "صندلی گهواره‌ای", rating: 4.9, category: "صنایع چوبی", price: "2,200,000 تومان", description: "صندلی راکینگ چیر چوبی، آرامش بخش.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 30 },
    ...
    2003: { id: 2003, title: "شلوار جین راسته", rating: 4.4, category: "پوشاک", price: "650,000 تومان", description: "شلوار جین با دوخت صنعتی و رنگ ثابت.", images: ["/ProductDetails.png"], colors: [{name:"آبی", hex:"#0D47A1", id:"blue"}], sizes: ["30", "32", "34", "36"], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 12 },
    2004: { id: 2004, title: "شلوار کتان کرم", rating: 4.2, category: "پوشاک", price: "580,000 تومان", description: "شلوار کتان با کشسانی مناسب و تن خور عالی.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 8 },
    2005: { id: 2005, title: "کفش چرم طبیعی تبریز", rating: 4.8, category: "پوشاک", price: "1,200,000 تومان", description: "کفش دست دوز چرم گاوی با کفی طبی.", images: ["/ProductDetails.png"], colors: [], sizes: ["40", "41", "42", "43"], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 22 },
    ...
    2007: { id: 2007, title: "کت و شلوار مجلسی", rating: 4.9, category: "پوشاک", price: "3,500,000 تومان", description: "ست کت و شلوار دامادی با دوخت مزونی.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 30 },
    ...
    2010: { id: 2010, title: "کلاه بافتنی زمستانی", rating: 4.3, category: "پوشاک", price: "120,000 تومان", description: "کلاه بافت گرم و نرم.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 6 },
    ...
    4002: { id: 4002, title: "تابلو خطاطی نستعلیق", rating: 4.9, category: "صنایع هنری", price: "1,800,000 تومان", description: "تابلو خوشنویسی شعر حافظ به خط نستعلیق.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 8 },
    4003: { id: 4003, title: "گلدان سفالی لعاب‌دار", rating: 4.5, category: "صنایع هنری", price: "250,000 تومان", description: "گلدان سفالی دست ساز با لعاب فیروزه ای.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 5 },
    4004: { id: 4004, title: "لیوان سفالی دست‌ساز", rating: 4.3, category: "صنایع هنری", price: "80,000 تومان", description: "ماگ سفالی طرح انار.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 3 },
    ...
    4007: { id: 4007, title: "بشقاب میناکاری", rating: 4.8, category: "صنایع هنری", price: "950,000 تومان", description: "بشقاب میناکاری شده اثر استادکاران اصفهان.", images: ["/ProductDetails.png"], colors: [], sizes: ["30 سانتی"], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 9 },
    4008: { id: 4008, title: "جعبه خاتم کاری", rating: 4.6, category: "صنایع هنری", price: "650,000 تومان", description: "جعبه جواهرات خاتم کاری نفیس.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 5 },

    // =========================================================================
    // Category: طلا و جواهر (Jewelry)
    // =========================================================================
    5001: {
        id: 5001, title: "گردنبند طلا طرح قلب", rating: 4.9, price: "12,000,000 تومان",
        description: "گردنبند طلا 18 عیار با طرح قلب ظریف و نگین های اتمی درخشان.",
        images: ["/ProductDetails.png"],
        colors: [{ name: "طلایی", hex: "#FFD700", id: "gold" }, { name: "سفید", hex: "#E0E0E0", id: "white_gold" }],
        sizes: ["40cm", "45cm"],
        specs: { "عیار": "18", "وزن": "4 گرم" },
        category: "طلا و جواهر",
        reviews: generateMockReviews(3, 5),
        ratingDistribution: defaultDistribution,
        reviewsCount: 20
    },
    5002: { id: 5002, title: "آویز طلا انار", rating: 4.7, category: "طلا و جواهر", price: "4,500,000 تومان", description: "پلاک طلا طرح انار مناسب شب یلدا.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 8 },
    5003: { id: 5003, title: "گوشواره مروارید", rating: 4.6, category: "طلا و جواهر", price: "3,200,000 تومان", description: "گوشواره میخ طلا با مروارید پرورشی.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 6 },
    5004: { id: 5004, title: "دستبند چرم و طلا", rating: 4.8, category: "طلا و جواهر", price: "2,800,000 تومان", description: "دستبند اسپرت چرم طبیعی با پلاک طلا.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 12 },
    5005: { id: 5005, title: "انگشتر نقره عقیق", rating: 4.5, category: "طلا و جواهر", price: "1,200,000 تومان", description: "انگشتر نقره مردانه با سنگ عقیق یمنی.", images: ["/ProductDetails.png"], colors: [], sizes: [], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 9 },
    5006: { id: 5006, title: "حلقه نامزدی برلیان", rating: 5.0, category: "طلا و جواهر", price: "45,000,000 تومان", description: "رینگ ازدواج طلا سفید با نگین برلیان اصل.", images: ["/ProductDetails.png"], colors: [], sizes: ["52", "54", "56"], specs: {}, reviews: [], ratingDistribution: defaultDistribution, reviewsCount: 45 },
