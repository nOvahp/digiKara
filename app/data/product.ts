...
export const products: Product[] = [
  ...
  {
    id: 2010,
    title: 'کلاه بافتنی زمستانه',
    price: '420,000 ریال',
    rating: 4.5,
    image: '/knitted-hat-gray-g199.jpg',
    category: 'پوشاک',
